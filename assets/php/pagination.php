...
class Pagination
{
    ...
    /**
     * Funktion zur Ermittlung der aktuellen Seite
     * 
     * @return
     */
    private function setCurrentPage($currentPage)
    {
        # erhalten die Seitennummer
        $this->current_page = $currentPage;

        # wenn die aktuelle Seite > 0
        if ($this->current_page > 0) {
            # wenn die aktuelle Seite kleiner als die Gesamtanzahl der Seiten
            if ($this->current_page > $this->amount)
            # rücken die aktuelle Seite an die letzte Stelle
                $this->current_page = $this->amount;
        } else
        # ist sie an der ersten Stelle
            $this->current_page = 1;
    }

    /**
     * Funktion für die Ermittlung der Gesamtanzahl der Seiten
     * 
