<?php
	...
	class Myaccount implements Account {
		//Variablen für die Ausgabe des Kontos
		private $all_account;
		private $customerid;
		private $firstname;
		private $lastname;
		...
		//Methode zur Abfrage und Ausgabe der Nutzerdaten
		public function account($username){
			...
			$this -> all_account = $stmt -> fetchall();

			foreach ($this -> all_account as $account){
		...
		public function changepassword(){
			if (isset($_POST["submitchangepassword"])){
				...
				$stmt -> execute();
				$row = $stmt -> fetch();
				//Prüfung der Eingabe des alten Passworts mit dem Passwort in der Datenbank (Hashvergleich)
