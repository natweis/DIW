<?php
	require_once("assets/php/Singlesubject.php");
	$temp         = new Singlesubject($_GET['id']);
...
<head>
	...
	<link rel="stylesheet" href="assets/css/subject-styles.css">
...
<div class="container">
	<div class="row">
		<h1><?php
				echo $temp -> getSubjectName(); ?></h1>
	</div>
	<div class="card" id="TableSorterCard">
		<div class="row table-topper align-items-center">
			<div class="col-4 text-left" style="margin: 0px;padding: 5px 15px;">
				<button class="btn btn-primary btn-sm reset" type="button" style="padding: 5px;margin: 2px;">Reset
				                                                                                             Filters
				</button>
